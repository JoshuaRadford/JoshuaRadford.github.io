...
(function ()
{
    ...
    Delaunay.prototype = {
        ...
        triangulate: function ()
        {
            ...
            for (var i = pts.length - 1; i >= 1; i--)
                // Costly operation, but there shouldn't be that many duplicates
            ...
            let quadEdge = delaunay(pts, this).le;

            let faces = this.getFaces(quadEdge);
    ...
    function delaunay(s, del)
    {
        ...
        { // |S| >= 4
            ...
            var left = delaunay(s.slice(0, half_length), del);
            var right = delaunay(s.slice(half_length), del);
